        ...
        <div>
            <div class="master xpert-form">
                ...
                <section class="flex-form">
                    <p class="input-total"><input type="text" maxlength="9" id="cli-nif" class="input-2"
                                                  placeholder="NIF"></p>
                    <p class="input-2"><input type="text" id="cli-nome" class="input-total" placeholder="Nome"></p>
                    <p class="input-2"><input type="text" id="cli-sobNome" class="input-total" placeholder="Sobrenome">
                    </p>
                    <p class="input-2"><input type="text" id="cli-dataNasc" class="input-total is-datepicker"
                ...
                <section class="flex-form">
                    ...
                    <p class="input-2"><input type="text" id="cli-salar" class="input-total  formatNumber double"
                                              placeholder="Salário"></p>
                    <p class="input-2">
                ...
                <section class="flex-form">
                    ...
                    <p class="input-3"><input type="text" id="cli-cont-telm" class="input-total integer"
                                              placeholder="Telemóvel"></p>
                    <p class="input-3"><input type="text" id="cli-cont-telf" class="input-total integer _noObrigatory"
                                              placeholder="Telefone"></p>
                    <p class="input-3"><input type="text" id="cli-cont-tels" class="input-total integer _noObrigatory"
                                              placeholder="Serviço"></p>
                    <p class="input-total"><input type="text" id="cli-email" class="input-total _noObrigatory"
                                                  placeholder="Email"></p>
                ...
                <div class="xpert-form">
                    ...
                    <div class="div-total">
                        <section class="flex-form part-1">
                            ...
                            <span class="xpert-is-wl span-v input-total">
											Valor: <input type="text" id="cred-value"
                                                          class="input-total formatNumber double init-value">
										</span>
                            ...
                            <input type="text" id="cred-desco" value="0" placeholder="Desconto (10%-20%)"
                                   title="Desconto (10%-20%)" class="input-2 double percent1020">
                            <input type="text" id="cred-corr" value="0" placeholder="Correção" title="Correção"
                                   class="input-2 double formatNumber">
                    ...
                    <div class="div-total-2">
                        ...
                        <section class="flex-form add-detail-table">
                            ...
                            <input id="cred-tab-amor-numDoc" type="text" placeholder="Nº Documento"
                                   title="Número documento" class="input-total">
                    ...
                    <span>
									...
									<div class="flex-form" id="cred-form-cli">
										<div class="x-list-select input-total">
											<input type="text" id="cred-cli-bank" placeholder="Banco" title="Banco"
                                                   class="input-total" readonly>
											<ul id="cred-cli-bank-list"></ul>
										</div>
										<div class="special-ipt">
											<span placeholder="Nº Doc. p/ pgto" id="cred-cli-numDoc-veiw"></span>
											<input type="text" id="cred-cli-numDoc" placeholder="Nº Doc. p/ pgto"
                                                   title="Número documento" class="integer" maxlength="3">
										</div>
            ...
            <div class="content">
                ...
                <div class="secDiv xpert-form">
                    <section class="sec-same flex-form ">
                        ...
                        <input type="text" placeholder="Data" id="cred-pay-data"
                               class="input-total date-liquida is-datepicker">
                        <input type="text" placeholder="Valor" id="cred-pay-value"
                               class=" formatNumber double input-total number-right" disabled>
...
<section class="modalPage mp-liquidar-full" id="cred-pay-form-full" style="display: block">
    <div class="modalFrame">
        <div class="modalContainer">
            <div class="content">
                <p class="type-font">
                    <i class="icon-checkbox-unchecked" id="cred-pay-dife-full">
                        <label>Fonte de pagamento diferente</label>
                    </i>
                </p>
                <div class="secDiv xpert-form">
            ...
            <div class="modal-header">
                <b>Efetuar pagamento anticipado</b>
                <span class="mp-close"></span>
            </div>
        </div>
    </div>
